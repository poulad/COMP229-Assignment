<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewRecipes.aspx.cs" Inherits="COMP229_assignment01.ViewRecipes" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="contentPlaceHolder">
	<div class="container">
		<div class="row">
			...
			<asp:ObjectDataSource runat="server" ID="DataSourceRecipes" SelectMethod="GetMyRecipes" TypeName="COMP229_assignment01.ViewRecipes"></asp:ObjectDataSource>
		</div>
	</div>
</asp:Content>
